...
public class BTree<T> {
  ...
  private int count(BTNode<T> n){
     ...
     else if(n.getLeft()!=null && n.getRight()==null) return (1+ count(n.getLeft()));
  ...
  private int level(BTNode<T> n, T v){
    if (n.getValue().equals(v)) return 0;

    else if (n.getLeft()!=null && n.getRight()!=null){
      return Math.min( 1 + level(n.getLeft(),v),1 + level(n.getRight(),v));
    }
    else if(n.getLeft()==null && n.getRight()!=null) return (1 + level(n.getRight(),v));
    else if(n.getLeft()!=null && n.getRight()==null) return (1 + level(n.getLeft(),v));
    return depth()+1;
