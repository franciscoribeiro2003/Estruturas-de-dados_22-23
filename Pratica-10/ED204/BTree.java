...
public class BTree<T> {   
   ...
   public int numerofolhas(BTNode<T> n){
      if (n.getLeft()==null && n.getRight()==null) return 1;
      else if (n.getLeft()==null && n.getRight()!=null) return numerofolhas(n.getRight());
      else if (n.getRight()==null && n.getLeft()!=null) return numerofolhas(n.getLeft());

      return numerofolhas(n.getLeft()) + numerofolhas(n.getRight());

   }

   public int numberLeafs(){
      return numerofolhas(root);
   }
}
