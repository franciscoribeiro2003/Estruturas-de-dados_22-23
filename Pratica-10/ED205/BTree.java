...
public class BTree<T> {   
   ...
   public boolean E_binaria(BTNode<T> n){
      if (n.getLeft()==null && n.getRight()==null) return true;
      else if (n.getLeft()==null && n.getRight()!=null) return false;
      else if (n.getRight()==null && n.getLeft()!=null) return false;

      return E_binaria(n.getLeft()) && E_binaria(n.getRight());

   }

   public boolean strict(){
      return E_binaria(root);
   }
}
